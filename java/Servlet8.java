...
"</TABLE>");
            ...
            FileInputStream filein = new FileInputStream("C:/Users/sagar/Documents/NetBeansProjects/HumaneSociety/src/java/lostpets.ser");
            ...
            for (int i=0; i<arraylist.size(); i++)
            {
             // out.println("<TABLE align=\"center\"><TR><TD>"+arraylist.get(i).PetType +"</TD><TD>"+arraylist.get(i).Breed+"</TD><TD>"+arraylist.get(i).Color+"</TD><TD>"+arraylist.get(i).Sex+"</TD></TR></TABLE>");
              ...
              out.println("<<TABLE align=\"center\"><TR><TD><a href=\"Servlet9?OwnerName="+arraylist.get(i).OwnerName+"&Address="+arraylist.get(i).Address+"&PhoneNumber="+arraylist.get(i).PhoneNumber+"\">" + arraylist.get(i).PetType + arraylist.get(i).Breed + arraylist.get(i).Color + arraylist.get(i).Sex + "</a></TD></TR></TABLE>");
              out.println("<br>");
            }    
            ...
            out.println("Error Occured in Servlet 8");
        } finally {
            out.close();
        }
    }
