...
"</TABLE>");
          ...
          //  p1.ht.remove(key);
            ...
            /*Serializing the modified hashtable to the File*/
          ...
          //  s.SerializationDetails(p1, out);
            ...
            {
               Pets p = arraylist.get(i);
               
              // if(p.equals(pets))
               if(p.petname.equals(petname) && p.pettype.equals(pettype) && p.breed.equals(breed) && p.color.equals(color) && p.size.equals(size) && p.sex.equals(sex))
               {
                  arraylist.remove(i);
               }                                                          
            }    
            ...
            /* Need to Serialiaze the arraylist object into file */
            ...
            out.println(" <TABLE align=\"center\"><TR><TD><h1>Thanks for Adopting</h1></TD></TR></TABLE> ");            
            out.println("</body>");
            out.println("</html>");
        } catch (Exception ex) {
            out.println("Error Occured in Servlet3");
        } finally {
            out.close();
        }
    }
