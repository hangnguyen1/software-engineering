...
"</TABLE>");
            ...
            foundpet.PetType=pettype;
            foundpet.Breed=breed;
            foundpet.Color=color;
            foundpet.Sex=sex;
            foundpet.YourName=yourname;
            foundpet.Address=address;
            foundpet.PhoneNumber=phonenumber;                                    
            
            /*DeSerializing the LostPet Details from File*/
            FileInputStream filein1 = new FileInputStream("C:/Users/sagar/Documents/NetBeansProjects/HumaneSociety/src/java/foundpets.ser");
            ...
            if(filein1.available()>0)
            {
               ...
               if(objin1!=null)
               {
                ...
                /* Adding Current found Pet Details to the Existing found Pet Details */
                arraylist.add(foundpet);
                objin1.close();
               }    
            }             
            ...
            FileOutputStream fileout = new FileOutputStream("C:/Users/sagar/Documents/NetBeansProjects/HumaneSociety/src/java/foundpets.ser");
            ObjectOutputStream objout = new ObjectOutputStream(fileout);
            objout.writeObject(arraylist);
            objout.close();
            fileout.close();
            out.println("<br>");
            out.println(" <TABLE align=\"center\"><TR><TD><h1>Found Pet Details are Stored in the File System!!!Thank You</h1></TD></TR></TABLE> ");
            
            /*DeSerializing the found pet details from File */
            
            FileInputStream filein2 = new FileInputStream("C:/Users/sagar/Documents/NetBeansProjects/HumaneSociety/src/java/foundpets.ser");
            ObjectInputStream objin2 = new ObjectInputStream(filein2);            
            arraylist = (ArrayList)objin2.readObject();
            
            out.println("<TABLE align=\"center\" border=\"1\"><TR><TD>PetType</TD><TD>Breed</TD><TD>Color</TD><TD>Sex</TD><TD>OwnerName</TD><TD>Address</TD><TD>PhoneNumber</TD></TR></TABLE>");
            for (int i=0; i<arraylist.size(); i++)
            {
              out.println("<TABLE align=\"center\"><TR><TD>"+arraylist.get(i).PetType +"</TD><TD>"+arraylist.get(i).Breed+"</TD><TD>"+arraylist.get(i).Color+"</TD><TD>"+arraylist.get(i).Sex+"</TD><TD>"+arraylist.get(i).YourName+"</TD><TD>"+arraylist.get(i).Address+"</TD><TD>"+arraylist.get(i).PhoneNumber+"</TD></TR></TABLE>");
              out.println("<br>");
            }    
            ...
            out.println("Error occured in Servlet5");
        } finally {
            out.close();
        }
    }
